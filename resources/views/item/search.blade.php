                ...
                <form action="{{ route('items.search') }}" method="get" class="form-inline d-flex">
                    @csrf
                        <div class="flex-grow-1">
                            <input type="text" name="keyword" class="form-control w-50" placeholder="キーワード検索（タイトル、キャスト、公開年など）">
                            <input type="submit" class="btn btn-sm btn-outline-primary" value="検索">
                        </div>
                </form>
            </div>
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">MOVIE ALL</h3>
                    ...
                    <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">@sortablelink('cast', 'キャスト')</th>
                                <th>詳細</th>
                                <th>商品写真</th>
